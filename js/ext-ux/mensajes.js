Ext.ns('eNuevoOriente.mensajes');
Ext.ns('eno');
eNuevoOriente.mensajes.mensajeDeEspera="Procesando la petici&oacute;n, por favor espere unos segundos.";
eno.mensajeDeEspera=eNuevoOriente.mensajes.mensajeDeEspera;

eNuevoOriente.mensajes.requestError=function(btn,form){
                ...
                if (responseData.success){					
					...
					Ext.Msg.show({
						...
						fn: function(btn){							
							...
							eNuevoOriente.mensajes.requestError(btn,options.scope.form);
						},
						icon:  icon,
						buttons: Ext.Msg.OK
					});					
