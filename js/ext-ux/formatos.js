...
eNuevoOriente.timestampToJsDate=function(timestamp){
...
Ext.data.Types.STRING = {
    convert: function(v, data) {
        return eNuevoOriente.formatearTexto(v);
    },
    sortType: function(v) {
        return v;
    },
...
Ext.data.Types.MONEDA = {
    convert: function(v, data) {
        ...
        return eNuevoOriente.formatearMoneda(v);
    },
    sortType: function(v) {
        return v;
    },
...
Ext.data.Types.CANTIDAD = {
    convert: function(v, data) {
        ...
        return eNuevoOriente.formatearCantidad(v);
    },
    sortType: function(v) {
        return v;
    },
...
Ext.data.Types.FECHAHORA = {
    convert: function(v, data) {
        return eNuevoOriente.timestampToJsDate(v);
    },
    sortType: function(v) {
        return v;
    },
...
*************************************************************************************************************************************/
    ...
    eNuevoOriente.formatear=function(valor,field){
        if (valor!=null & field.formatear!=false){
           ...
           if (tipo=="mayusculas"  || tipo.type=='mayusculas'){                
            ...
            if (tipo=="moneda"  || tipo.type=='moneda'){                
                return  eNuevoOriente.formatearMoneda(valor);
            }
            if (tipo=="cantidad" || tipo.type=='cantidad'){
                return  eNuevoOriente.formatearCantidad(valor);
            }
            if ( tipo=='string' || tipo.type=='string'){
                return  eNuevoOriente.formatearTexto(valor);
            }
            if (tipo=='tel' || tipo.type=='tel'){
                return  eNuevoOriente.formatearTelefono(valor);
            }
        }
        return valor;
    };

    eNuevoOriente.formatearCantidad=function(valor){
     
     if (eNuevoOriente.parametros.dec_can_par!=undefined){
         var decimales=eNuevoOriente.parametros.dec_can_par;
    ...
    eNuevoOriente.formatearMoneda=function(valor){
     //   alert('formatearMoneda'+valor);
     if (eNuevoOriente.parametros.decimales_cantidad!=undefined){
        var decimales=eNuevoOriente.parametros.decimales_cantidad;
		var cantidad = parseFloat(valor);
        return cantidad.toFixed(decimales);
     }else{
         return valor;
    ...
    eNuevoOriente.formatearTexto=function(valor){
     // alert('formatearTexto'+valor);alert('formatearTexto'+valor);
	  if (valor==null){
		return valor;
	  }
	  valor=valor.toString();
        switch(eNuevoOriente.UserConfig.forUsu){
            case "1":
				try {
	 ...
	 eNuevoOriente.formatearCorreo=function(valor){
     // alert('formatearTexto'+valor);alert('formatearTexto'+valor);
	  if (valor==null){
		return valor;
	  }
	...
	eNuevoOriente.formatearSinFormato=function(valor){
     // alert('formatearTexto'+valor);alert('formatearTexto'+valor);
	  if (valor==null){
		return valor;
	  }
    ...
    eNuevoOriente.formatearTelefono=function(num_sf){
