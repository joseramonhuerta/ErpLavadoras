	...
	if(isset($_POST)){
		...
		try{
			...
			if($id_orden_servicio > 0){
				...
				//genero el pago
				$consulta="INSERT INTO ordenes_servicio(nombre_cliente,fecha,nombre_equipo, modelo_equipo, serie_equipo, descripcion_falla, nombre_tecnico, descripcion_diagnostico, descripcion_reparacion, importe_presupuesto, status_servicio, celular) 
				...
				'{$descripcion_reparacion}', '{$importe_presupuesto}',{$status_servicio},'{$celular}')";
				$resultado=mysqli_query($conexion,$consulta);
