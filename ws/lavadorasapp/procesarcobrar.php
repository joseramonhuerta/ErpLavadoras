...
$msg="";
	if(isset($_GET["id_pedido"])){
		...
		try{
			...
			//genero el pago
			$consulta="INSERT INTO pagos(id_pedido,id_trabajador,fecha_pago,importe,status, origen,usercreador, fechacreador) values({$id_pedido},{$id_trabajador},now(),{$importe},'A',2,{$id_usuario},now())";
			$resultado=mysqli_query($conexion,$consulta);
